...
const audit = [
  // GitHub Pages renders docs/ with Jekyll; just-the-docs builds its sidebar
  // from front matter. This file is rewritten on every run, so the front matter
  // belongs here rather than in the page.
  "---",
  "title: Schema audit",
  "parent: API and data",
  "nav_order: 5",
