...
## Summary
- 2902 nodes · 5359 edges · 238 communities (183 shown, 55 thin omitted)
...
## Communities (238 total, 55 thin omitted)
...
### Community 1 - "Service"
Cohesion: 0.11
Nodes (18): github.com/lib/pq.StringArray, AuthResult, passwordRecord, ActiveSecret(), TokenIntrospection, User, ParseTokenWithRing(), findUserByEmail() (+10 more)
...
Cohesion: 0.08
Nodes (23): el, qc, el, qc, deleteMock, getMock, ConfirmCtx, ConfirmProvider() (+15 more)
...
### Community 11 - "Route"
Cohesion: 0.21
Nodes (8): Route, Upstreams, Config, TestProxyUsesValidatedClientIP(), Matcher, NewMatcher(), ParseUpstreams(), TestConsumerQuotaUsesAuthenticatedSubject()
...
Cohesion: 0.06
Nodes (35): chi.Context, frontendError, InitErrorReporter(), ReportError(), toError(), chiRouteContext(), recordAPIError(), recordBuildInfo() (+27 more)
...
Cohesion: 0.09
Nodes (28): BulkPermissionResult, Loggerish, ErrBadRequest(), ErrConflict(), ErrInternal(), ErrUnauthorized(), AppError, Role (+20 more)

### Community 19 - "Client"
Cohesion: 0.08
Nodes (23): github.com/coder/websocket.Conn, net/http/httptest.Server, sync.RWMutex, Hub, Client, prometheusGauge, contains(), Handlers (+15 more)
...
### Community 67 - "main"
Cohesion: 0.18
Nodes (13): StartPprof(), redis.Client, NewRedisClient(), WaitForRedis(), config, closeDB(), main(), pingDB() (+5 more)
...
### Community 103 - "main"
Cohesion: 0.14
Nodes (22): consumerQuotaPolicy, ctxKeyAuth, net/netip.Prefix, Fail(), redis_rate.Limiter, AggregateDocs(), ScalarHandlers(), TestScalarPageHasExecutableCSPAndSRI() (+14 more)
...
Cohesion: 0.09
Nodes (25): testing.T, FeatureEnabled(), discardLogger(), TestEnvelopeGoldenFile(), TestFailEnvelopeShape(), TestGormLoggerTrace(), TestListOKShape(), TestOKEnvelopeShape() (+17 more)
...
### Community 152 - "newResilientTransport"
Cohesion: 0.28
...
Cohesion: 0.19
Nodes (13): DecryptForSubject(), DeriveKey(), EncryptForSubject(), KeyedDigest(), VerifyDigest(), TestSecurityPrimitives(), TestStreamMessageSigningAndEncryption(), ValidatePublicHTTPSURL() (+5 more)
...
Cohesion: 0.12
Nodes (15): context.Context, ErrNotFound(), All(), RunSeedVersion(), RegistrationDay, UserStats, Hub, redis.Client (+7 more)
...
Cohesion: 0.13
Nodes (13): container/list.Element, container/list.List, sync.Mutex, cachedClaims, claimEntry, ClaimsClient, Audit(), Loggerish (+5 more)
...
### Community 187 - "net/http.Handler"
Cohesion: 0.54
...
Cohesion: 0.17
Nodes (14): time.Duration, redis.Client, TryDistributedLock(), DistributedLock, Config, Claims, jwt.RegisteredClaims, mint() (+6 more)

### Community 196 - "testing.F"
Cohesion: 0.33
Nodes (5): testing.F, FuzzHandlerDecode(), FuzzUserOrderClauseNeverIncludesInput(), FuzzValidateProfileFields(), TestProfileSecurityValidation()
...
### Community 216 - "gorm.io/gorm.DB"
Cohesion: 0.27
Nodes (9): gorm.io/gorm.DB, net/http.HandlerFunc, ParsePagination(), PurgeDeletedProfiles(), RefreshReadModels(), AuditExport(), auditQuery(), AuditViewer() (+1 more)
...
## Knowledge Gaps
- **817 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+812 more)
