...
## Corpus Check
- 548 files · ~291,669 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3783 nodes · 6816 edges · 329 communities (246 shown, 83 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 306 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1374c103`
...
- open-docs.mjs
- Q: Implement all Developer Experience backlog items J1-J76
...
- redis-bigkeys.sh
- UnescapedCookieParamError
- Q: sekarang kerjakan semua fitur BACKLOG.md untuk kategori CI/CD & Release dengan tipe Engineering. lalu kerjakan juga C9, C10, C11, C12, C35, C39, C47, C48 dan C52 juga ikut dikerjakan.
...
- DECISIONS.md
- Engineering guide
- 0003-users-table-ownership.md
- smoke-deploy.sh
- Schema governance audit
- Product roadmap implementation
- 0002-integer-identities.md
- quarantine/README.md
- Profile
- deploy-prod.sh
- MiddlewareRegistry
- Infra and operations
- 0004-consolidated-migration-baseline.md
- vite
- SpecRouteTable
...
- docs/BACKLOG.md Improvement Backlog
...
- run
- Q: Implement all Product / Roadmap backlog items except R44, R45, and R56
...
1. `WriteError()` - 72 edges
2. `OK()` - 67 edges
3. `ErrBadRequest()` - 46 edges
4. `Service` - 45 edges
5. `ServerInterfaceWrapper` - 31 edges
6. `useToast()` - 30 edges
7. `Handlers` - 30 edges
8. `main()` - 30 edges
9. `ServerInterfaceWrapper` - 29 edges
10. `scripts` - 27 edges
...
- `AssignDefaultRole()` --references--> `UserCreatedEvent`  [EXTRACTED]
  services/rbac/internal/consumer.go → internal/platform/events.go
...
## Communities (329 total, 83 thin omitted)
...
### Community 1 - "Service"
Cohesion: 0.08
Nodes (28): github.com/lib/pq.StringArray, AuthResult, passwordRecord, ActiveSecret(), sessionView, TokenIntrospection, User, findUserByEmail() (+20 more)
...
Cohesion: 0.04
Nodes (48): dependencies, @phosphor-icons/react, react, react-dom, @starter/contracts, @starter/ui, @tanstack/react-query, devDependencies (+40 more)

### Community 5 - "ui-system.tsx"
Cohesion: 0.06
Nodes (29): el, qc, deleteMock, getMock, patchMock, permissions, postMock, putMock (+21 more)

### Community 6 - "devDependencies"
Cohesion: 0.04
Nodes (48): dependencies, react, react-dom, @starter/contracts, @starter/ui, devDependencies, jsdom, msw (+40 more)

### Community 7 - "devx.mjs"
Cohesion: 0.19
Nodes (27): compose, dbShell(), delve(), docker(), ensureService(), fail(), fakeUsers(), handlerSignature() (+19 more)
...
Cohesion: 0.06
Nodes (37): description, devDependencies, jsdom, react, react-dom, @testing-library/react, @types/react, @types/react-dom (+29 more)

### Community 10 - "App.tsx"
Cohesion: 0.07
Nodes (22): AuthRoutes(), ForbiddenPage(), ForgotPage, Gate(), handleLoggedIn(), handleReauthenticated(), LoginPage, LoginResult (+14 more)

### Community 11 - "Route"
Cohesion: 0.17
Nodes (11): Route, Upstreams, Config, Matcher, NewMatcher(), ParseUpstreams(), TestClientIPOnlyTrustsConfiguredProxy(), TestConsumerQuotaUsesAuthenticatedSubject() (+3 more)
...
Cohesion: 0.07
Nodes (39): api, ActivityFeed(), ActivityItem, ColumnKey, columnLabel(), copyText(), csvCell(), dateBoundary() (+31 more)

### Community 14 - "formatter"
Cohesion: 0.20
Nodes (10): enabled, indentStyle, indentWidth, lineWidth, semicolons, javascript, formatter, globals (+2 more)

### Community 15 - "log/slog.Logger"
Cohesion: 0.09
Nodes (31): log/slog.Logger, InitErrorReporter(), ReportError(), toError(), CorrelationID(), DebugRequest(), debugRequest(), InjectTraceHeaders() (+23 more)

### Community 16 - "CI/CD and release controls"
Cohesion: 0.25
Nodes (8): Change freeze, CI/CD and release controls, Environments and promotion, Images, releases, and retention, Pipeline lanes and change impact, Preview environments, Recorded decisions, Required repository rules
...
Cohesion: 0.08
Nodes (13): context.Context, ErrNotFound(), RunSeedVersion(), ProductAnalytics, Role, Publisher, bumpVerTx(), Service (+5 more)

### Community 19 - "Client"
Cohesion: 0.13
Nodes (11): sync.RWMutex, Hub, Client, prometheusGauge, Handlers, NewHandlers(), NewHandlersWithKeyRing(), jsonMarshal() (+3 more)
...
Cohesion: 0.08
Nodes (31): chi.Context, AdminSetUserPasswordJSONBody, AdminSetUserPasswordJSONRequestBody, AdminSetUserStateJSONBody, AdminSetUserStateJSONBodyStatus, AdminSetUserStateJSONRequestBody, ChangePasswordJSONBody, ChangePasswordJSONRequestBody (+23 more)

### Community 23 - "scripts"
Cohesion: 0.07
Nodes (27): scripts, build, check:architecture, check:budget, check:ci, check:deps, check:devx, check:migrations (+19 more)
...
Cohesion: 0.06
Nodes (49): useRealtimeUsers(), ProductPage, AuthAction, AuthContext, AuthProvider(), authReducer(), AuthSession, AuthState (+41 more)
...
Cohesion: 0.10
Nodes (19): gorm.io/gorm.DB, Consumer, WorkerHandler, redis.XMessage, SweepSessions(), PurgeDeletedProfiles(), RefreshReadModels(), contains() (+11 more)

### Community 31 - "DashboardShell.tsx"
Cohesion: 0.06
Nodes (44): Root(), applyTheme(), HealthState, Theme, useGatewayHealth(), useTheme(), OfflineBanner(), CommandPalette() (+36 more)
...
### Community 34 - "StartPprof"
Cohesion: 0.29
Nodes (6): bytes.Buffer, StartPprof(), TestStartPprofOnlyListensOnLoopback(), TestStartPprofReportsAFailedBind(), waitForLog(), lockedBuffer

### Community 35 - "main.tsx"
Cohesion: 0.16
Nodes (10): App(), observeWebVitals(), rating(), report(), VitalName, el, worker, handlers (+2 more)
...
Cohesion: 0.06
Nodes (34): openapi-fetch, openapi-typescript, dependencies, openapi-fetch, zod, description, devDependencies, js-yaml (+26 more)
...
Cohesion: 0.21
Nodes (14): CI: commitlint job, CI: go job (lint/build/test/contracts), CI: playwright smoke job, CI: security (Trivy + Semgrep) job, CI: web job (lint/test/build/budget), CI Workflow, release-please job, Release Workflow (+6 more)
...
Cohesion: 0.12
Nodes (17): devDependencies, msw, @originjs/vite-plugin-federation, tailwindcss, @tailwindcss/vite, terser, @testing-library/react, @types/react-dom (+9 more)

### Community 44 - "time.Time"
Cohesion: 0.08
Nodes (21): Permission, Role, Session, encoding/json.RawMessage, time.Time, auditRow, MFAEnrollment, PermissionInfo (+13 more)

### Community 45 - "Testing & QA"
Cohesion: 0.25
...
Cohesion: 0.08
Nodes (30): ADR-0001: Fresh-build Pivot, GORM Replaces sqlc/pgx-direct, Ops Files Per Component, Gateway Topology, Observability Flow, BACKLOG (1.202 improvement items), Backlog: Architecture & Scalability, Backlog: CI/CD & Release (+22 more)
...
Cohesion: 0.09
Nodes (19): bySlashPath(), byTag, check, composeFiles, configFiles, directGo, envFiles, envRows (+11 more)

### Community 50 - "Handlers"
Cohesion: 0.20
Nodes (5): AuthorizeResource(), MeParams, Handlers, validator.Validate, SubFromContext()

### Community 51 - "main"
Cohesion: 0.24
Nodes (14): consumerQuotaPolicy, net/netip.Prefix, SetSlowRequestThreshold(), redis_rate.Limiter, clientIP(), corsHandler(), edgeRateLimit(), envFile() (+6 more)

### Community 52 - "RolesPage.tsx"
Cohesion: 0.07
Nodes (33): api, PermissionInfo, Role, AuditEntry, DeleteRoleModal(), download(), exportMatrixPng(), iconGlyphs (+25 more)
...
### Community 54 - "secureRequest"
Cohesion: 0.15
Nodes (15): SettingsPage(), beginMFA(), changePassword(), eraseAccount(), exportData(), finishOnboarding(), readNotification(), requestEmailChange() (+7 more)
...
Cohesion: 0.10
Nodes (19): before 04:00 on monday, before 05:00 on monday through friday, config:recommended, dependencies, :semanticCommits, :semanticCommitScope(deps), dependencyDashboard, extends (+11 more)

### Community 59 - "deploy.sh"
Cohesion: 0.25
Nodes (14): APP_VERSION, BUILD_DATE, build_images(), compose(), die(), docker_publishes(), ensure_docker(), GIT_COMMIT (+6 more)
...
### Community 62 - "index.tsx"
Cohesion: 0.07
Nodes (36): AccessibleTable(), BoundaryProps, DateRangePicker(), EmptyState(), FileDropzone(), FormErrorSummary(), I18nContext, I18nProvider() (+28 more)

### Community 63 - "testing.T"
Cohesion: 0.08
Nodes (32): net/http.Transport, testing.T, ParsePagination(), discardLogger(), TestBuildMIME(), TestEnvelopeGoldenFile(), TestGormLoggerTrace(), TestListOKShape() (+24 more)

### Community 64 - "Migrate"
Cohesion: 0.11
Nodes (10): main(), Migrate(), migrationURL(), TestMigrationURLUsesServiceHistory(), MigrateUp(), migrateUp(), MigrateUp(), migrateUp() (+2 more)

### Community 65 - "ListUsersParams"
Cohesion: 0.15
Nodes (7): ListUsersParamsCount, ListUsersParamsInclude, ListUsersParamsLimit, ListUsersParamsOrder, ListUsersParamsPresence, ListUsersParamsSort, ListUsersParams
...
### Community 69 - "resilience-drill.sh"
Cohesion: 0.33
...
Cohesion: 0.10
Nodes (21): `audit.audit_logs`, `audit.event_outbox`, `audit.processed_messages`, `auth.change_log`, `auth.identity_tokens`, `auth.login_events`, `auth.sessions`, Constraints (+13 more)

### Community 81 - "web/package.json"
Cohesion: 0.40
Nodes (4): name, private, type, version

### Community 82 - "schemas.ts"
Cohesion: 0.08
Nodes (23): adminSetUserPasswordSchema, adminSetUserStateSchema, bulkCreatePermissionsSchema, changePasswordSchema, confirmPasswordSchema, consumeMagicLinkSchema, createPermissionSchema, createProductRecordSchema (+15 more)

### Community 84 - "ErrBadRequest"
Cohesion: 0.14
Nodes (14): LoginEvent, oauthConfig, ErrBadRequest(), ErrConflict(), ErrInternal(), AppError, ValidatePublicHTTPSURL(), ProductRecordInput (+6 more)

### Community 85 - "newUsersFixture"
Cohesion: 0.16
Nodes (15): profileOption, userAuditPublisher, T, pointer(), TestProductRecordsEnforceVisibilitySecretsAndSingletons(), TestValidateProductInputDefaults(), TestValidateProductSemanticsRejectsUnsafeConfiguration(), Profile (+7 more)
...
### Community 90 - "Handlers"
Cohesion: 0.11
Nodes (10): ListOK(), SetPaginationLinks(), listData, Meta, LoginHistoryParams, DeleteRoleParams, ListRoleUsersParams, Handlers (+2 more)

### Community 91 - "startFixture"
Cohesion: 0.18
Nodes (21): gorm.io/gorm/logger.Interface, NewGormLogger(), closeDB(), fixture, redis.Client, newSilentGormLogger(), openDB(), publish() (+13 more)

### Community 92 - "web/vite.config.ts"
Cohesion: 0.23
Nodes (6): cdnOrigin, cdnOrigin, cdnOrigin, cdnOrigin, devAliases, localDevServer()
...
### Community 96 - "Fail"
Cohesion: 0.19
Nodes (12): net/http.HandlerFunc, Fail(), WriteJSON(), TestFailEnvelopeShape(), SecretMatch(), failEnvelope, okEnvelope, redis.Client (+4 more)

### Community 97 - "check-devx.mjs"
Cohesion: 0.27
Nodes (10): envProblems(), findProblems(), generatedProblems(), policyProblems(), problems, root, skipped, todoProblems() (+2 more)

### Community 98 - "mailer.go"
Cohesion: 0.21
Nodes (10): net/smtp.Auth, BuildMIME(), Mail, Mailer, NewMailer(), recordingMailer, ConsoleMailer, FallbackMailer (+2 more)
...
### Community 103 - "WriteError"
Cohesion: 0.08
Nodes (21): ctxKeyHash, forgotInput, loginInput, OK(), ErrUnauthorized(), WriteError(), registerInput, resetInput (+13 more)

### Community 105 - "CODE_OF_CONDUCT.md"
Cohesion: 0.17
Nodes (9): Contributor Covenant Code of Conduct, Expected behavior, Our pledge, Scope and enforcement, Service ownership, Decisions, Governance, Releases and changes to governance (+1 more)

### Community 106 - "FrontendErrors"
Cohesion: 0.60
Nodes (3): frontendError, FrontendErrors(), validFrontendError()

### Community 108 - "ClaimsClient"
Cohesion: 0.27
Nodes (6): container/list.Element, container/list.List, cachedClaims, claimEntry, ClaimsClient, NewClaimsClient()

### Community 109 - "ParseAccessTokenRing"
Cohesion: 0.29
...
### Community 113 - "RUNBOOK.md"
Cohesion: 0.16
Nodes (9): Afterward, Incident response playbook, Response, Roles, Severity, Current hypothesis, Incident timeline, Mitigation and rollback point (+1 more)

### Community 114 - "NewRouter"
Cohesion: 0.16
Nodes (13): Readyz(), chi.Router, NewRouter(), GracefulRun(), shutdownTimeout(), Checker, config, bearerGuard() (+5 more)

### Community 115 - "package.json"
Cohesion: 0.20
Nodes (9): engines, node, lint-staged, *.go, *.{js,mjs,ts,tsx,json,jsonc,css}, name, packageManager, private (+1 more)

### Community 116 - "Frontend engineering standard"
Cohesion: 0.18
Nodes (10): Accessibility, Contrast audit, Forms, contracts, and errors, Frontend engineering standard, Language, design, and motion decisions, Loading and rendering, PWA, privacy, and experiments, Shared component and hook inventory (+2 more)

### Community 120 - "web-admin-users/package.json"
Cohesion: 0.40
Nodes (4): name, private, type, version

### Community 123 - "open-docs.mjs"
Cohesion: 0.40
Nodes (3): port, root, services

### Community 125 - "Q: Implement all Developer Experience backlog items J1-J76"
Cohesion: 0.50
Nodes (3): Answer, Outcome, Q: Implement all Developer Experience backlog items J1-J76

### Community 142 - "Contracts Pipeline (spec-first)"
Cohesion: 0.11
Nodes (21): Schema-per-Service Decision, Spec-First Without a Behavioral Contract, API Versioning Policy, Deliberately Avoided Versioning Practices, Deprecation Mechanics (RFC-9745), /api/v1 Frozen Contract, Adding v2 API Strategy, Fail-Closed Route Registry (+13 more)

### Community 149 - "AGENTS.md"
Cohesion: 0.33
Nodes (4): Architecture, Commands, Conventions that bite, graphify
...
### Community 153 - "users/internal/handlers.go"
Cohesion: 0.13
Nodes (16): testing.B, Handlers, BenchmarkWriteJSON(), profileInput, avatarHandlers(), TestResizeAvatarHandlerRejectsBadUploads(), TestResizeAvatarHandlerReturnsJpeg(), decodeListCursor() (+8 more)

### Community 154 - "GormLogger"
Cohesion: 0.22
Nodes (4): gorm.io/gorm/logger.LogLevel, queryOperation(), slowQuerySampled(), GormLogger

### Community 155 - "KeyedDigest"
Cohesion: 0.17
Nodes (14): DecryptForSubject(), DeriveKey(), EncryptForSubject(), KeyedDigest(), VerifyDigest(), TestSecurityPrimitives(), DecodeStreamMessage(), redis.Client (+6 more)
...
Cohesion: 0.11
Nodes (20): ListCursor, ListFilters, Audit(), Loggerish, AuditEvent, StreamPublisher, RegistrationDay, UserStats (+12 more)

### Community 158 - "openapi-diff.mjs"
Cohesion: 0.50
Nodes (3): outputDir, report, root
...
### Community 160 - "RemoteErrorBoundary.tsx"
Cohesion: 0.22
Nodes (5): CopyErrorButton(), Props, RemoteErrorBoundary, State, useCopy()

### Community 162 - "Observability"
Cohesion: 0.22
...
### Community 164 - "ScalarHandlers"
Cohesion: 0.40
Nodes (3): AggregateDocs(), ScalarHandlers(), TestScalarPageHasExecutableCSPAndSRI()

### Community 166 - "users/gen/gen.go"
Cohesion: 0.07
Nodes (30): MeParamsInclude, ProductKind, ProductRecord, ProductRecordInput, ProductRecordUpdate, RequestEmailChangeJSONRequestBody, ResizeAvatarMultipartBody, ResizeAvatarMultipartRequestBody (+22 more)

### Community 168 - "dependencies"
Cohesion: 0.11
Nodes (17): @docusaurus/core, @docusaurus/preset-classic, @easyops-cn/docusaurus-search-local, dependencies, @docusaurus/core, @docusaurus/preset-classic, @easyops-cn/docusaurus-search-local, react (+9 more)

### Community 169 - "NewLogger"
Cohesion: 0.19
...
### Community 170 - "registry-retention.mjs"
Cohesion: 0.33
Nodes (5): apply, candidates, ownerType, pages, versions

### Community 174 - "time.Duration"
Cohesion: 0.20
Nodes (15): time.Duration, readSlowRequestThreshold(), config, Config, Claims, jwt.RegisteredClaims, MintAccess(), MintAccessWithRing() (+7 more)

### Community 175 - "api-changelog.mjs"
Cohesion: 0.17
Nodes (10): added, after, before, changed, current, methods, previous, removed (+2 more)

### Community 176 - "DoD Evidence Checklist"
Cohesion: 0.14
Nodes (14): Web Micro-frontend Federation, Backlog: Developer Experience, Spec-to-Typed-Client Pipeline, DoD Evidence Checklist, Onboarding Guide, Dev/Lab/UAT/Demo/Prod Environments, Local Gate Pipeline (mirrors CI), PR Checklist (+6 more)

### Community 177 - "main"
Cohesion: 0.20
Nodes (11): T, LoadDotEnv(), loadSecretFiles(), MustParseEnv(), TestLoadDotEnv(), TestSecretFileEnvAdapterIgnoresOptionalAppEnvFile(), envGet(), writeFile() (+3 more)

### Community 182 - "Q: sekarang kerjakan semua fitur BACKLOG.md untuk kategori CI/CD & Release dengan tipe Engineering. lalu kerjakan juga C9, C10, C11, C12, C35, C39, C47, C48 dan C52 juga ikut dikerjakan."
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: sekarang kerjakan semua fitur BACKLOG.md untuk kategori CI/CD & Release dengan tipe Engineering. lalu kerjakan juga C9, C10, C11, C12, C35, C39, C47, C48 dan C52 juga ikut dikerjakan., Source Nodes

### Community 183 - "TestRoomsBroadcastDenyAndForceLogoutKick"
Cohesion: 0.26
...
### Community 185 - "promote.sh"
Cohesion: 0.80
Nodes (4): audit(), notify(), rollback(), promote.sh script
...
### Community 187 - "main"
Cohesion: 0.23
Nodes (9): redis.Client, NewRedisClient(), WaitForRedis(), RegisterSessionMetrics(), lowerEnv(), main(), pingDB(), seedAdmin() (+1 more)

### Community 189 - "check-change-freeze.mjs"
Cohesion: 0.50
Nodes (3): active, config, now

### Community 193 - "Developer experience"
Cohesion: 0.18
...
### Community 195 - "NewRequestValidator"
Cohesion: 0.25
...
Cohesion: 0.50
Nodes (3): failures, markers, required
...
Cohesion: 0.20
Nodes (12): sync.Mutex, qaLogger, qaPublisher, RoleInput, contains(), Service, newRBACFixture(), roleBuilder() (+4 more)

### Community 201 - "index.md"
Cohesion: 0.09
Nodes (15): API contract standards, Platform and event surface, Requests and collections, Responses, caching, and compatibility, API schema defaults and nullability audit, ARCHITECTURE overview, JWT Verified Once At Edge, Direct dependency licenses (+7 more)

### Community 202 - "main"
Cohesion: 0.20
Nodes (10): redis.Client, NewScheduler(), RecordHousekeeping(), TestSchedulerSkipsTickWhenTheLockCheckFails(), Scheduler, closeDB(), envFile(), main() (+2 more)
...
### Community 204 - "blendWhite"
Cohesion: 0.24
Nodes (8): image/color.Color, io.Reader, blendWhite(), platformBadAvatar(), ResizeAvatar(), TestBlendWhiteFlattensTransparencyWithoutOverflow(), TestResizeAvatarBoundsAndFormat(), TestResizeAvatarRejectsInvalidInput()

### Community 205 - "main"
Cohesion: 0.27
Nodes (9): go.opentelemetry.io/otel/sdk/resource.Resource, InitTracer(), newResource(), traceSampleRatio(), trimSchemeHTTP(), config, closeDB(), main() (+1 more)
...
### Community 212 - "TryDistributedLock"
Cohesion: 0.25
Nodes (6): redis.Client, NewLeaderElector(), redis.Client, TryDistributedLock(), DistributedLock, LeaderElector
...
Cohesion: 0.22
Nodes (9): Can I edit an existing migration?, Frequently asked questions, How are generated files handled?, Is multi-region enabled?, Where do identity and profile data live?, Which local mode should I use?, Why does the frontend keep access tokens only in memory?, Why is a route returning 404 even though a handler exists? (+1 more)

### Community 217 - ".FinishOAuth"
Cohesion: 0.40
Nodes (3): FinishOAuthParams, FinishOAuthParamsProvider, clientIP()

### Community 218 - "pull_request_template.md"
Cohesion: 0.40
Nodes (4): Change, Impact and delivery, Release notes draft, SQL / migration review

### Community 219 - "OpenDatabase"
Cohesion: 0.62
...
Cohesion: 0.12
Nodes (15): aggregateSpec, API curl examples, exportAuditEntries, gateway, healthz, listAuditEntries, ping, platform (+7 more)

### Community 224 - "users"
Cohesion: 0.08
Nodes (25): createProductRecord, createUserProfile, deleteProductRecord, deleteUser, eraseMe, exportMyData, getUser, getUserStats (+17 more)
...
### Community 232 - "github.com/oapi-codegen/runtime/types.Email"
Cohesion: 0.18
Nodes (10): ForgotInput, LoginInput, Profile, ProfileInput, ProfileStatus, ProfileUpdateInput, RegisterInput, RequestEmailChangeJSONBody (+2 more)

### Community 233 - "ignore"
Cohesion: 0.22
Nodes (9): ignore, .claude/**, .codex/**, **/coverage/**, **/dist/**, docs/BACKLOG.md, graphify-out/**, **/node_modules/** (+1 more)

### Community 234 - "adr/README.md"
Cohesion: 0.20
Nodes (8): Architecture Decision Records, Index, ADR-NNNN: Short decision title, Alternatives, Consequences, Context, Decision, Verification

### Community 235 - "resilientTransport"
Cohesion: 0.12
Nodes (19): context.CancelFunc, io.ReadCloser, net/http.Header, net/http.Response, sync/atomic.Uint64, bufferedWriter, cachedResponse, cancelBody (+11 more)

### Community 236 - "health.go"
Cohesion: 0.53
Nodes (5): buildValue(), Drain(), Healthz(), Version(), TestHealthDetailAndVersion()

### Community 237 - "rules"
Cohesion: 0.22
Nodes (9): useExhaustiveDependencies, useHookAtTopLevel, linter, enabled, rules, correctness, recommended, style (+1 more)

### Community 239 - "webhook.go"
Cohesion: 0.29
...
### Community 242 - "SUPPORT.md"
Cohesion: 0.20
Nodes (5): Bundle audit, Performance engineering evidence, Published ports, Support, Where to ask
...
### Community 245 - "PublishWithAuditOutbox"
Cohesion: 0.22
Nodes (6): redis.Client, PublishWithAuditOutbox(), RedisPublisher, redis.Client, RedisPublisher, redis.Client
...
### Community 249 - "rbac/internal/service.go"
Cohesion: 0.13
Nodes (19): testing.F, BulkPermissionResult, Loggerish, RoleInput, userRole, Claims, Publisher, NewService() (+11 more)
...
### Community 256 - "DECISIONS.md"
Cohesion: 0.14
Nodes (10): ADR-0005: Monorepo delivery, Consequences, Context, Decision, Cadence, Collaboration and knowledge sharing, Pair and mob programming, Decision log (+2 more)

### Community 257 - "Engineering guide"
Cohesion: 0.29
Nodes (7): Definition of done by work type, Engineering guide, Git workflow, Go standards, Naming, Review guide, TypeScript and React standards

### Community 258 - "0003-users-table-ownership.md"
Cohesion: 0.33
Nodes (4): ADR-0003: Move profile data to the users schema, Consequences, Context, Decision

### Community 260 - "Schema governance audit"
Cohesion: 0.33
Nodes (5): ck_/fk_/uq_ naming exceptions (8), Columns without comments (27), Required columns without defaults (31), Schema governance audit, Time columns not using TIMESTAMPTZ (0)

### Community 261 - "Product roadmap implementation"
Cohesion: 0.33
Nodes (5): Accepted product decisions, Capability evidence, Operations and security, Operator workflow, Product roadmap implementation

### Community 262 - "0002-integer-identities.md"
Cohesion: 0.40
Nodes (4): ADR-0002: Integer identities, Consequences, Context, Decision

### Community 265 - "Profile"
Cohesion: 0.33
Nodes (4): Profile, RoleSummary, Config, RoleSummary

### Community 267 - "MiddlewareRegistry"
Cohesion: 0.60
Nodes (3): Middleware, MiddlewareRegistry, NewMiddlewareRegistry()

### Community 268 - "Infra and operations"
Cohesion: 0.22
Nodes (8): Availability, residency, and communication, Backup, secrets, and immutable releases, Capacity, monitoring, and housekeeping, Docker, networking, and service discovery, Host security baseline, Infra and operations, Portability and air-gapped operation, Provision and bootstrap

### Community 269 - "0004-consolidated-migration-baseline.md"
Cohesion: 0.20
Nodes (8): ADR-0004: Consolidated migration baseline, Consequences, Context, Decision, Between minor releases, Environment-by-environment, Upgrading, Documentation snapshot 0.1

### Community 271 - "SpecRouteTable"
Cohesion: 0.15
Nodes (11): net/url.URL, All(), IsValid(), MustValid(), TestDynamicRoutingConfiguration(), TestMiddlewareRegistryHonorsConfiguredOrder(), TestSpecRouteExtensions(), ParseConsumerQuotas() (+3 more)

### Community 272 - "Q: periksa deploy.yml dari .github/workflows, terdapat warning ini Context access might be invalid: UAT_URL"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: periksa deploy.yml dari .github/workflows, terdapat warning ini Context access might be invalid: UAT_URL, Source Nodes

### Community 273 - "go-platform-starter"
Cohesion: 0.40
Nodes (5): About these pages, Conventions that bite, Four rules that explain most of the code, go-platform-starter, Start where your question is

### Community 274 - "Release process"
Cohesion: 0.40
Nodes (4): Before merge, Cut a release, Release process, Rollback and hotfix

### Community 276 - "Q: Kerjakan semua fitur BACKLOG kategori Infra & Ops tipe Engineering serta F31, F53, dan F54"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: Kerjakan semua fitur BACKLOG kategori Infra & Ops tipe Engineering serta F31, F53, dan F54, Source Nodes

### Community 278 - "Maintenance announcement: <short title>"
Cohesion: 0.40
Nodes (4): Before, Completion, Maintenance announcement: <short title>, Updates

### Community 279 - "Q: Implement all Frontend Engineering backlog items including decision items: current frontend architecture, state, loading, accessibility, i18n, themes, forms, tables, errors, performance and testing"
Cohesion: 0.50
Nodes (3): Answer, Outcome, Q: Implement all Frontend Engineering backlog items including decision items: current frontend architecture, state, loading, accessibility, i18n, themes, forms, tables, errors, performance and testing

### Community 284 - "run"
Cohesion: 0.60
Nodes (4): main(), run(), valueOr(), io.Writer

### Community 285 - "Q: Implement all Product / Roadmap backlog items except R44, R45, and R56"
Cohesion: 0.50
Nodes (3): Answer, Outcome, Q: Implement all Product / Roadmap backlog items except R44, R45, and R56

### Community 286 - "TestDatabaseTimeoutsPreserveDSN"
Cohesion: 0.40
Nodes (3): FeatureEnabled(), TestDatabaseTimeoutsPreserveDSN(), TestFeatureEnabled()

### Community 291 - "ProxyHandler"
Cohesion: 0.29
Nodes (8): ProxyDeps, serviceStatus, clearIdentity(), redis.Client, LoadSpecs(), primaryEndpoint(), ProxyHandler(), StatusPage()

### Community 293 - "Q: bagian Product / Roadmap di docs/BACKLOG.md itu untuk apa?"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: bagian Product / Roadmap di docs/BACKLOG.md itu untuk apa?, Source Nodes

### Community 297 - ".CreateProductRecord"
Cohesion: 0.13
Nodes (15): ctxKeyEmail, ctxKeyPerms, ErrForbidden(), ListProductRecordsParams, SearchProductParams, Handlers, T, productActor() (+7 more)

### Community 299 - "run-with-retry.mjs"
Cohesion: 0.40
Nodes (3): first, reportIndex, separator

### Community 300 - "LoginPage.tsx"
Cohesion: 0.07
Nodes (55): api, apiError(), AuthApiError, forgot(), login(), LoginResult, readMessage(), register() (+47 more)

### Community 301 - "recordBuildInfo"
Cohesion: 0.40
Nodes (3): recordAPIError(), recordBuildInfo(), TestRuntimeProcessAndBuildCollectorsAreRegistered()

### Community 305 - "NewHandlers"
Cohesion: 0.50
Nodes (3): TestGeneratedServicePing(), Handlers, NewHandlers()

### Community 307 - "Capacity and cost planning"
Cohesion: 0.50
Nodes (3): Capacity and cost planning, Capacity worksheet, Monthly cost worksheet

## Knowledge Gaps
- **1203 isolated node(s):** `name`, `version`, `private`, `type`, `dev` (+1198 more)
...
- `CI Workflow` (2× useful, score=1.969228537) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Deprecation()` connect `Contracts Pipeline (spec-first)` to `net/http.Request`, `ProxyHandler`, `Security Posture`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Contracts Pipeline (spec-first)` connect `Contracts Pipeline (spec-first)` to `DoD Evidence Checklist`, `Security Posture`, `CONTRIBUTING.md`, `index.md`?**
...
- **Should `net/http.Request` be split into smaller, more focused modules?**
  _Cohesion score 0.04185837728649983 - nodes in this community are weakly interconnected._
