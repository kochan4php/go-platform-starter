...
## Corpus Check
- 478 files · ~246,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3217 nodes · 5699 edges · 269 communities (205 shown, 64 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 265 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0d090e65`
...
### Community 5 - "ui.tsx"
Cohesion: 0.06
Nodes (32): el, qc, deleteMock, getMock, patchMock, permissions, postMock, putMock (+24 more)
...
### Community 10 - "RemoteErrorBoundary.tsx"
Cohesion: 0.25
...
Cohesion: 0.08
Nodes (30): BulkPermissionResult, Loggerish, PermissionInfo, ErrBadRequest(), ErrConflict(), ErrForbidden(), ErrInternal(), ErrNotFound() (+22 more)
...
Cohesion: 0.05
Nodes (36): @axe-core/playwright, @biomejs/biome, js-yaml, devDependencies, @axe-core/playwright, @biomejs/biome, js-yaml, @playwright/test (+28 more)
...
Cohesion: 0.08
Nodes (26): gorm.io/gorm.DB, Consumer, TestTraceAndBaggageMapRoundTrip(), RunSeedVersion(), ExtractTraceMap(), TraceIDFromContext(), WorkerHandler, redis.XMessage (+18 more)
...
Cohesion: 0.06
Nodes (27): AuthLoginFailureRate, AuthSessionErrors, CertificateExpiresSoon, FrontendErrorBurst, HostDiskSpaceLow, MailQueueBacklog, On-call alert runbook, PlatformErrorRateAnomaly (+19 more)
...
Cohesion: 0.16
Nodes (13): DeleteRoleModal(), RoleModal(), Probe(), SessionMenu(), timezoneOptions(), useConfirm(), useDrawer(), usePreferences() (+5 more)

### Community 45 - "DoD Evidence Checklist"
Cohesion: 0.12
Nodes (16): Ops Files Per Component, Deliberately Avoided Versioning Practices, Web Micro-frontend Federation, Backlog: Developer Experience, Spec-to-Typed-Client Pipeline, DoD Evidence Checklist, Onboarding Guide, Dev/Lab/UAT/Demo/Prod Environments (+8 more)
...
### Community 51 - "PublishWithAuditOutbox"
Cohesion: 0.20
Nodes (7): redis.Client, PublishWithAuditOutbox(), InjectTraceMap(), RedisPublisher, redis.Client, RedisPublisher, redis.Client
...
Cohesion: 0.10
Nodes (26): api, AuthContext, AuthProvider(), SessionUser, RequirePermission(), addBreadcrumb(), ApiClient, Breadcrumb (+18 more)

### Community 63 - "mailer.go"
Cohesion: 0.11
Nodes (17): net/http.Client, net/smtp.Auth, HTTPWebhookProvider, BuildMIME(), Mail, Mailer, NewMailer(), TestBuildMIME() (+9 more)
...
Cohesion: 0.22
Nodes (11): AuditEvent, profileOption, userAuditPublisher, Profile, redis.Client, Service, newUsersFixture(), profileBuilder() (+3 more)
...
Cohesion: 0.16
Nodes (13): testing.B, WriteJSON(), BenchmarkWriteJSON(), profileInput, failEnvelope, okEnvelope, decodeListCursor(), encodeListCursor() (+5 more)

### Community 91 - "startFixture"
Cohesion: 0.17
Nodes (22): gorm.io/gorm/logger.Interface, gorm.io/gorm/logger.LogLevel, NewGormLogger(), recordingMailer, closeDB(), fixture, redis.Client, newSilentGormLogger() (+14 more)
...
### Community 96 - "main"
Cohesion: 0.24
Nodes (8): GracefulRun(), shutdownTimeout(), RegisterSessionMetrics(), lowerEnv(), main(), pingDB(), seedAdmin(), sqlClose()
...
Cohesion: 0.14
Nodes (16): time.Duration, redis.Client, TryDistributedLock(), DistributedLock, config, Config, Claims, jwt.RegisteredClaims (+8 more)
...
Cohesion: 0.33
Nodes (10): net/http.Handler, chi.Router, ChiServerOptions, ServerInterface, Handler(), HandlerFromMux(), HandlerFromMuxWithBaseURL(), HandlerWithOptions() (+2 more)

### Community 142 - "testing.T"
Cohesion: 0.08
Nodes (31): net/http.Transport, testing.T, ParsePagination(), discardLogger(), TestEnvelopeGoldenFile(), TestFailEnvelopeShape(), TestGormLoggerTrace(), TestListOKShape() (+23 more)
...
Cohesion: 0.09
Nodes (25): time.Time, MFAEnrollment, permissionRow, DecryptForSubject(), DeriveKey(), EncryptForSubject(), KeyedDigest(), VerifyDigest() (+17 more)
...
Cohesion: 0.12
Nodes (18): context.Context, ListCursor, ListFilters, Audit(), Loggerish, StreamPublisher, RegistrationDay, UserStats (+10 more)
...
### Community 181 - "AuditViewer"
Cohesion: 0.31
Nodes (8): encoding/json.RawMessage, net/http.HandlerFunc, auditRow, SecretMatch(), AuditExport(), auditQuery(), AuditViewer(), TestAuditViewerPaginatesAndGuardsSecret()
...
Cohesion: 0.24
Nodes (9): qaLogger, qaPublisher, RoleInput, Service, newRBACFixture(), roleBuilder(), TestAssignDefaultRoleIsIdempotent(), TestPermissionAndRoleAssignmentIntegration() (+1 more)

### Community 201 - "ClaimsClient"
Cohesion: 0.28
...
### Community 234 - "MiddlewareRegistry"
Cohesion: 0.60
...
Cohesion: 0.18
Nodes (10): testing.F, SecurityHeaders(), ValidatePublicHTTPSURL(), FuzzPermissionNameGrammar(), FuzzHandlerDecode(), FuzzUserOrderClauseNeverIncludesInput(), FuzzValidateProfileFields(), TestProfileSecurityValidation() (+2 more)
...
Cohesion: 0.19
Nodes (12): github.com/lib/pq.StringArray, passwordRecord, randomToken(), checkHIBP(), passwordHistoryContains(), passwordNeedsRehash(), RandomPassword(), sha1Hex() (+4 more)

### Community 268 - "ParseAccessTokenRing"
Cohesion: 0.29
...
## Knowledge Gaps
- **1032 isolated node(s):** `Pipeline lanes and change impact`, `Required repository rules`, `Environments and promotion`, `Preview environments`, `Images, releases, and retention` (+1027 more)
...
- **Why does `Deprecation()` connect `Contracts Pipeline (spec-first)` to `net/http.Request`, `ProxyHandler`, `validateProfileFields`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **What connects `Pipeline lanes and change impact`, `Required repository rules`, `Environments and promotion` to the rest of the system?**
