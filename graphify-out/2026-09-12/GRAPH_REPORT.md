...
## Corpus Check
- 542 files · ~289,056 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3738 nodes · 6753 edges · 313 communities (235 shown, 78 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 298 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8015c45`
...
## Communities (313 total, 78 thin omitted)
...
### Community 1 - "Service"
Cohesion: 0.11
Nodes (19): github.com/lib/pq.StringArray, passwordRecord, TokenIntrospection, ParseTokenWithRing(), findUserByEmail(), CalibrateBcryptCost(), hashPassword(), passwordHistoryContains() (+11 more)

### Community 2 - "net/http.Request"
Cohesion: 0.04
Nodes (15): net/http.Request, net/http.ResponseWriter, ServerInterfaceWrapper, Unimplemented, MiddlewareFunc, ServerInterfaceWrapper, Unimplemented, MiddlewareFunc (+7 more)
...
Cohesion: 0.12
Nodes (14): Permission, Role, Session, time.Time, MFAEnrollment, permissionRow, Session, sessionView (+6 more)
...
Cohesion: 0.13
Nodes (20): chi.Context, chiRouteContext(), CorrelationID(), DebugRequest(), debugRequest(), LoggerFromContext(), newRequestID(), Observe() (+12 more)
...
Cohesion: 0.10
Nodes (22): BulkPermissionResult, Loggerish, PermissionInfo, Role, RoleInput, userRole, Publisher, bumpVerTx() (+14 more)
...
Cohesion: 0.09
Nodes (25): BulkCreatePermissionsJSONBody, BulkCreatePermissionsJSONRequestBody, CreatePermissionJSONBody, CreatePermissionJSONRequestBody, RoleInput, SetUserRolesJSONBody, SetUserRolesJSONRequestBody, UpdateRoleJSONBody (+17 more)

### Community 25 - "WriteError"
Cohesion: 0.09
Nodes (14): AuthorizeResource(), OK(), ErrUnauthorized(), WriteError(), currentRefreshHash(), Config, Handlers, Service (+6 more)
...
Cohesion: 0.18
Nodes (11): log/slog.Logger, cachedClaims, claimEntry, withBaseLogger(), chi.Router, NewRouter(), NewClaimsClient(), Handlers (+3 more)
...
Cohesion: 0.10
Nodes (21): @axe-core/playwright, @commitlint/cli, @commitlint/config-conventional, husky, lint-staged, markdownlint-cli2, devDependencies, @axe-core/playwright (+13 more)
...
Cohesion: 0.11
Nodes (14): encoding/json.RawMessage, auditRow, ErrBadRequest(), ValidatePublicHTTPSURL(), ProductAnalytics, ProductOverview, ProductRecord, ProductRecordInput (+6 more)
...
Cohesion: 0.17
Nodes (13): ctxKeyEmail, ctxKeyPerms, ErrForbidden(), Handlers, T, productActor(), value(), EmailFromContext() (+5 more)
...
### Community 69 - "users/internal/service.go"
Cohesion: 0.13
Nodes (16): testing.F, ListCursor, ListFilters, RegistrationDay, UserStats, FuzzPermissionNameGrammar(), estimateEligible(), FuzzHandlerDecode() (+8 more)
...
### Community 84 - "User"
Cohesion: 0.19
Nodes (8): AuthResult, LoginEvent, oauthConfig, User, randomToken(), fetchOAuthIdentity(), Service, unavailable()
...
Cohesion: 0.18
Nodes (22): gorm.io/gorm/logger.Interface, NewGormLogger(), recordingMailer, FlushAuditOutbox(), closeDB(), fixture, redis.Client, newSilentGormLogger() (+14 more)
...
### Community 96 - "main"
Cohesion: 0.14
Nodes (13): redis.Client, NewRedisClient(), WaitForRedis(), SweepSessions(), RegisterSessionMetrics(), RandomPassword(), redis.Client, RateLimit() (+5 more)
...
Cohesion: 0.15
Nodes (14): gorm.io/gorm.DB, net/http.HandlerFunc, redis.Client, PublishWithAuditOutbox(), ParsePagination(), SecretMatch(), RedisPublisher, redis.Client (+6 more)
...
### Community 103 - "main"
Cohesion: 0.17
Nodes (16): consumerQuotaPolicy, ctxKeyAuth, net/netip.Prefix, redis_rate.Limiter, AggregateDocs(), ScalarHandlers(), TestScalarPageHasExecutableCSPAndSRI(), clientIP() (+8 more)
...
Cohesion: 0.08
Nodes (29): testing.T, discardLogger(), TestEnvelopeGoldenFile(), TestGormLoggerTrace(), TestListOKShape(), TestOKEnvelopeShape(), TestPaginationLinks(), TestParsePagination() (+21 more)
...
Cohesion: 0.15
Nodes (10): container/list.Element, container/list.List, sync.Mutex, ClaimsClient, Audit(), Loggerish, AuditEvent, StreamPublisher (+2 more)

### Community 155 - ".Refresh"
Cohesion: 0.17
Nodes (14): DecryptForSubject(), DeriveKey(), EncryptForSubject(), KeyedDigest(), VerifyDigest(), TestSecurityPrimitives(), TestStreamMessageSigningAndEncryption(), ActiveSecret() (+6 more)
...
Cohesion: 0.13
Nodes (11): context.Context, ErrConflict(), ErrInternal(), ErrNotFound(), AppError, RunSeedVersion(), ErrConflictEmail(), Hub (+3 more)
...
Cohesion: 0.21
Nodes (9): validEmail(), el, claimsOf(), formatCountdown(), LoginPage(), startOAuthLogin(), submit(), SessionPayload (+1 more)

### Community 170 - "registry-retention.mjs"
Cohesion: 0.33
Nodes (5): apply, candidates, ownerType, pages, versions

### Community 174 - "Security Posture"
Cohesion: 0.19
...
Cohesion: 0.29
Nodes (11): api, apiError(), forgot(), login(), LoginResult, readMessage(), register(), requestMagicLink() (+3 more)
...
Cohesion: 0.33
Nodes (8): verifyInvitation(), authNavigate(), validPassword(), registerMock, validateResetMock, RegisterPage(), ResetPage(), submit()
...
Cohesion: 0.15
Nodes (17): context.CancelFunc, io.ReadCloser, net/http.Response, net/http.Transport, sync/atomic.Uint64, cachedResponse, cancelBody, endpointState (+9 more)
...
### Community 268 - "normalizeEmail"
Cohesion: 0.43
Nodes (7): normalizeEmail(), useEmailDraft(), ForgotPage(), send(), submit(), sendMagicLink(), submit()
...
Cohesion: 0.08
Nodes (16): ctxKeyHash, forgotInput, loginInput, registerInput, resetInput, FinishOAuthParams, FinishOAuthParamsProvider, LoginHistoryParams (+8 more)
...
- **Should `net/http.Request` be split into smaller, more focused modules?**
  _Cohesion score 0.040037535189239915 - nodes in this community are weakly interconnected._
