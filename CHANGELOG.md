...
* **ci:** clear semgrep and the -race test failures ([2a36b3e](https://github.com/kochan4php/go-platform-starter/commit/2a36b3ea184a8892d0efcb27429b0250d71540a9))
* **ci:** clear the remaining red gates ([53c47a6](https://github.com/kochan4php/go-platform-starter/commit/53c47a667d13b1ac968d4c40fa0199559d4a9f57))
* **ci:** correct the config errors the previous round introduced ([57fd18c](https://github.com/kochan4php/go-platform-starter/commit/57fd18c0a667cc41572f7750e53e117baeca9cfa))
* **ci:** cover changed avatar/auth/pprof code and unblock lighthouse ([5b37a49](https://github.com/kochan4php/go-platform-starter/commit/5b37a49ed4fd75f6993426a6bfad93aa1095b165))
* **ci:** install danger's missing peer, quiet shellcheck, bump grpc ([f8015c4](https://github.com/kochan4php/go-platform-starter/commit/f8015c450671a26f67546f45f8e272b8b937ccea))
* **ci:** let Lighthouse score the login page instead of an error boundary ([429ad48](https://github.com/kochan4php/go-platform-starter/commit/429ad485b8fc0af2ffb7763fa46f0db67972803e))
* **ci:** make generated docs repo-derived and fix three job-specific faults ([aefe2a6](https://github.com/kochan4php/go-platform-starter/commit/aefe2a67d531ef332bf37a8ca004bed676ed4943))
* **ci:** refresh coverage badges and read Lighthouse reports where lhci writes them ([eabd768](https://github.com/kochan4php/go-platform-starter/commit/eabd768dfbc8834cd126780cad6994d6e0bffc5f))
* **ci:** repair concurrent registration, line endings, and two workflows ([fe802c6](https://github.com/kochan4php/go-platform-starter/commit/fe802c637fd3767cf737403ea7ef69d90d9065f5))
* **ci:** repair the four gates that fail on every branch ([c9d41bc](https://github.com/kochan4php/go-platform-starter/commit/c9d41bc502f52bbe3836d2c73e710f08a0fd5158))
* clear the go lint gate and the last CI failures ([81ac6cf](https://github.com/kochan4php/go-platform-starter/commit/81ac6cf6683caacfe549b38fbfa174ae1e460d5f))
* clear the go lint gate and the last CI failures ([6cca8b7](https://github.com/kochan4php/go-platform-starter/commit/6cca8b7ac31bfcb657fdee1bb6e8093029acb1ab))
...
* **platform:** make internal/platform coverage reproducible ([823ea3c](https://github.com/kochan4php/go-platform-starter/commit/823ea3c1400306476870070b04d3f0513d01169c))
...
* stabilize admin user and role workflows ([b5dc69f](https://github.com/kochan4php/go-platform-starter/commit/b5dc69fc9b0584d0495db4efce301082cafdb33c))
...
* **web:** close the leaked SRI comment and unstick two stale e2e assertions ([7d63181](https://github.com/kochan4php/go-platform-starter/commit/7d631819293795a05f5e9cd81461dd9d687b29f7))
